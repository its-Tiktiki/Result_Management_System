...
class AddStudentInfo(db.Model):
    ...
    marks = db.relationship("AddMarks", back_populates="student", cascade="all, delete-orphan")
...
class Attendance(db.Model):
    ...
    student_id = db.Column(db.Integer,db.ForeignKey("student_data.student_id", ondelete="CASCADE"),nullable=False,)
    ...
    student = db.relationship("AddStudentInfo", back_populates="attendance")
...
class AddMarks(db.Model):
    ...
    created_at = db.Column(db.DateTime, server_default=db.func.now())
    student = db.relationship("AddStudentInfo", back_populates="marks")
