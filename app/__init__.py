...
def create_app():
    ...
    from .routes.principal.subject_and_department.assign_subject_dashboard import (
        assign_subject_dashboard_bp,
    )
    from .routes.principal.subject_and_department.assign_subjects import (
        assign_subject_bp,
    )
    from .routes.principal.subject_and_department.assign_teacher import (
        assign_teacher_bp,
    )
    from .routes.principal.subject_and_department.get_subject import (
        get_subject_bp,
    )
    from .routes.principal.subject_and_department.show_subjects import (
        show_subjects_bp,
    )
    from app.routes.principal.subject_and_department.view_assigned_details.view_assigned_subject_details import (
        view_assigned_bp,
    )
    ...
    from .routes.teacher.get_marks_system.get_marks_dashboard import (
        get_marks_dashboard_bp,
    )
    from .routes.teacher.get_marks_system.get_marks_topic import (
        get_marks_topic_bp,
    )
    from .routes.teacher.get_marks_system.marks_details import (
        view_student_details_bp,
    )
