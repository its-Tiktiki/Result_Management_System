...
student_api = Blueprint("student_api", __name__, url_prefix="/api/students")
...
@student_api.route("/<int:student_id>", methods=["GET"])
...
# Get student by roll
@student_api.route("/roll/<int:roll>", methods=["GET"])
